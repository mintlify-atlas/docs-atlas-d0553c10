...
The utils module provides command-line tools for working with AlpaSim data.
...
<ParamField path="asl_file" type="string" required>
...
<ParamField path="--message-types" type="list">
  Message types to filter (e.g., actor_poses, drive_response, camera_image)
</ParamField>

<ParamField path="--just-types" type="flag">
...
<ParamField path="--output-format" type="string" default="mp4">
